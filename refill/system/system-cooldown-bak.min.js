...
async function CheckcoolDown(e) {
    return axios.post("../function/check_cooldown.php", {
        user_id: accountid,
        amount: e,
    }, {
        headers: {
...
async function FunctionPromptPay(e) {
    const CoolDown = await CheckcoolDown(e);
...
//     reqData.append('publicKey', gbpay_publicKey);
